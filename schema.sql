...
CREATE TABLE `Loc` (
  ...
  `areaType` enum('CHARGING','DISPATCH','STANDBY','STORAGE','EXTRA','ELEVATOR','ROBOTIC_ARM','CONVEYOR','LIFT_GATE','GATE_WAIT_POINT','PALLETIZER','ROTATE_TABLE') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `mock_wcs_station` (
  `id` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `machine_type` enum('CONVEYOR','LIFT_GATE','GATE_WAIT_POINT','ROBOTIC_ARM','ELEVATOR','PALLETIZER','CHARGING') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `peripheral_name` (
  ...
  `type` enum('CHARGING','DISPATCH','STANDBY','STORAGE','EXTRA','ELEVATOR','ROBOTIC_ARM','CONVEYOR','LIFT_GATE','GATE_WAIT_POINT','PALLETIZER','ROTATE_TABLE') COLLATE utf8mb4_unicode_ci NOT NULL,
